...
for taskid in ['6', '26', '30', '32', '137', '151', '183', '184', '251', '310', '375', '725',
    ...
    csvout = pd.DataFrame(columns=['DatasetID','Exp_Name','Condition', 'Level', 'Triplicate','Exp1ImputeRMSEAcc','Exp2ImputeModel','Exp2train_auroc','Exp2train_accuracy', 
                            ...
                            index=[ '/'+taskid+'_class_non_simple_MNAR_0.01_1/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.1_1/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.3_1/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.5_1/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.01_2/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.1_2/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.3_2/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.5_2/',
                                    '/'+taskid+'_class_non_simple_MNAR_0.01_3/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.1_3/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.3_3/',
                                     '/'+taskid+'_class_non_simple_MNAR_0.5_3/',
                                     '/'+taskid+'_class_simple_MNAR_0.01_1/',
                                     '/'+taskid+'_class_simple_MNAR_0.1_1/',
                                     '/'+taskid+'_class_simple_MNAR_0.3_1/',
                                     '/'+taskid+'_class_simple_MNAR_0.5_1/',
                                     '/'+taskid+'_class_simple_MNAR_0.01_2/',
                                     '/'+taskid+'_class_simple_MNAR_0.1_2/',
                                     '/'+taskid+'_class_simple_MNAR_0.3_2/',
                                     '/'+taskid+'_class_simple_MNAR_0.5_2/',
                                    '/'+taskid+'_class_simple_MNAR_0.01_3/',
                                     '/'+taskid+'_class_simple_MNAR_0.1_3/',
                                     '/'+taskid+'_class_simple_MNAR_0.3_3/',
                                     '/'+taskid+'_class_simple_MNAR_0.5_3/',
                                     '/'+taskid+'_class_full_MNAR_0.01_1/',
                                     '/'+taskid+'_class_full_MNAR_0.1_1/',
                                     '/'+taskid+'_class_full_MNAR_0.3_1/',
                                     '/'+taskid+'_class_full_MNAR_0.5_1/',
                                     '/'+taskid+'_class_full_MNAR_0.01_2/',
                                     '/'+taskid+'_class_full_MNAR_0.1_2/',
                                     '/'+taskid+'_class_full_MNAR_0.3_2/',
                                     '/'+taskid+'_class_full_MNAR_0.5_2/',
                                    '/'+taskid+'_class_full_MNAR_0.01_3/',
                                     '/'+taskid+'_class_full_MNAR_0.1_3/',
                                     '/'+taskid+'_class_full_MNAR_0.3_3/',
                                     '/'+taskid+'_class_full_MNAR_0.5_3/'
                                     ])
    #print(csvout)
    locallist=[]
    check_list=[]
    for exp in ['class_full_','class_simple_','class_non_simple_']:
        for item in ['MNAR_']:
                ...
                for iter in ['1/', '2/', '3/']:
                    ...
                    try:
                        ...
                        if (Exp3ImputeModel == 'IterativeImputer'):
                            ...
                            check_list.append(tpot_space['fit_model'][0])
                                
                        csvout.loc['/'+taskid+'_'+exp+item+lvl+iter] = pd.Series({'DatasetID':taskid,'Exp_Name': exp,'Condition': item, 'Level': lvl, 'Triplicate': iter,'Exp1ImputeRMSEAcc': est['impute_rmse'] ,'Exp2ImputeModel': '0.0','Exp2train_auroc': est['train_score']['train_auroc'],'Exp2train_accuracy': est['train_score']['train_accuracy'], 
...
output = result.to_csv(fileoutput+'class_fixed42545'+'.csv')
print('all csvs complete')
print('to redo:')
print(redolist)
print('list of iterative estimators')
print(check_list)